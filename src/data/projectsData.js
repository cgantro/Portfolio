...
export const featuredProjectDecks = [
  ...
  },
  {
    id: "mausoleum",
    name: "mausoleum",
    oneLine: "UE5 멀티플레이 게임에서 게임 세션과 음성 서버 책임을 분리하고 음성 UX를 개선한 프로젝트",
    cardImage: {
      src: mausoleumCardImage,
      alt: "mausoleum 대표 포스터 이미지",
    },
    stackTags: ["Unreal Engine 5", "C++", "전용 서버", "UDP"],
    slides: [
      {
        key: "overview",
        label: "Overview",
        ...
        leftBlocks: [
          {
            title: "프로젝트 소개",
            bullets: [
              "UE5 클라이언트, 전용 서버, UDP 음성 서버를 분리한 멀티플레이 프로젝트입니다.",
              "저는 보이스 UX 개선뿐 아니라 물리 기반 게임 세션 분리와 룸 코드 기반 논리 분리 설계를 담당했습니다.",
              "6인 팀에서 음성 처리, 세션/룸 분리 로직, 서버 연동 구조를 구현했습니다.",
            ],
          },
          {
            title: "핵심 기여",
            bullets: [
              ...
              "물리 기반 게임 세션을 대기/인게임 흐름과 분리해 상태 충돌을 줄였습니다.",
              "룸 코드 기반 논리 분리로 세션 간 이벤트/음성 간섭을 방지했습니다.",
        ...
        leftBlocks: [
          {
            ...
            bullets: [
              ...
              "물리 기반 게임 세션을 분리해 세션 충돌과 상태 간섭을 줄였습니다.",
          ...
          },
          {
            title: "부 기술 스택",
            bullets: [
              "룸 코드 기반 논리 분리로 세션 간 이벤트/음성 간섭을 차단했습니다.",
              "게임 월드 부하와 음성 부하를 분리해 안정성을 높였습니다.",
              "공간화 제어로 상황별 재생 방식을 분리했습니다.",
            ],
          },
        ],
        rightBlocks: [
          {
            type: "stack",
            title: "기술 스택",
            items: ["Unreal Engine 5", "C++", "전용 서버", "UDP"],
          },
          {
            type: "metrics",
            title: "선정 이유",
            items: [
              ...
              "물리 기반 게임 세션은 분리된 상태 경계가 필요했습니다.",
